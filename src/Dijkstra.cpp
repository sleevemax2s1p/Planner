...
list<Point *> *Dijkstra::getPath_raw(Point *start_point, Point *end_point, double &time, int &distance)
{
    if (!isInit)
    {
...
list<Point *> *Dijkstra::getPath_opt1(Point *start_point, Point *end_point, double &time, int &distance)
{
    if (!isInit)
    {
        ROS_INFO("Please Init the graph first!!! && Please find path first!!!");
...
list<Point *> *Dijkstra::getPath_opt2(Point *start_point, Point *end_point, double &time, int &distance)
{
    return getPath_raw(start_point, end_point, time, distance);
}
list<Point *> *Dijkstra::getPath_opt3(Point *start_point, Point *end_point, double &time, int &distance)
{
    return getPath_opt1(start_point, end_point, time, distance);
}
