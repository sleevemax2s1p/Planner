...
public:
    ...
    list<Point *> *getPath_raw(Point *start_point, Point *end_point, double &time, int &distance);
    list<Point *> *getPath_opt1(Point *start_point, Point *end_point, double &time, int &distance);
    list<Point *> *getPath_opt2(Point *start_point, Point *end_point, double &time, int &distance);
    list<Point *> *getPath_opt3(Point *start_point, Point *end_point, double &time, int &distance);
